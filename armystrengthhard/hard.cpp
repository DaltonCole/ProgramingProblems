...
int main() {
	...
	priority_queue<long, vector<long> > godzilla;
	priority_queue<long, vector<long> > mechagodzilla;
	...
	for(int i = 0; i < cases; i++) {
		...
		godzilla = priority_queue<long, vector<long> >();
		mechagodzilla = priority_queue<long, vector<long> >();
	}
